    ...
    return (
        <div className='about'id='about'>
            <div className='about__content' >
                ...
                <p data-aos="fade-up" className='about__content__text'>After several years operating in Human Ressources, my last experiences in tech oriented environnements, especially in talent aquisition management, made me want to be a part of projects development more concretely.</p>

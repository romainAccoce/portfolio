    ...
    return (
        <div className='contact' id='contact'>
            <div className='contact__content'>
                ...
                <p data-aos="fade-up" className='contact__content__text'>I’m interested in freelance opportunities, if you have any request or question, don’t hesitate to use the form. </p>
                <ContactForm />
            </div>
